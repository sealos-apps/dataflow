...
func isAllowed(r *http.Request, body []byte) bool {
	...
	case "Login", "LoginWithProfile", "BootstrapSealosSession", "ResolveSealosInstanceIdentity", "CreateStandaloneSession", "GetProfiles", "UpdateSettings", "SettingsConfig", "GetVersion",
